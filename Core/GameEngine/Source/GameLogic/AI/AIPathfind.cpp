...
// Only the diagnostic code paths below use GetTickCount / QueryPerformance*, and off Windows those
// come from Utility/time_compat.h instead. See docs/porting/timing-and-threading.md.
#if defined(_WIN32) && (defined(DEBUG_LOGGING) || defined(RTS_DEBUG) || defined(INTENSE_DEBUG))
#include <windows.h>
#endif

...
public:
	...
	virtual void reset() {
		...
		DX8Wrapper::Set_DX8_Texture_Uncached(0, nullptr);
		DX8Wrapper::Set_DX8_Texture_Uncached(1, nullptr);};
...
Bool ScreenDefaultFilter::postRender(FilterModes mode, Coord2D &scrollDelta,Bool &doExtraRender)
{
	...
	DX8Wrapper::Set_DX8_Texture_Uncached(0,tex);	//previously rendered frame inside this texture
...
{
	DX8Wrapper::Set_DX8_Texture_Uncached(0,nullptr);	//previously rendered frame inside this texture
...
Int ScreenBWFilter::set(FilterModes mode)
{
	...
	{	//rendering a quad with redirected rendering surface tinted by pixel shader
		...
		DX8Wrapper::Set_DX8_Pixel_Shader_Uncached(m_dwBWPixelShader);
		DX8Wrapper::Set_DX8_Pixel_Shader_Constant_Uncached(0,   D3DXVECTOR4(0.3f, 0.59f, 0.11f, 1.0f), 1);
...
//			color.z = 1.0f;
		...
		DX8Wrapper::Set_DX8_Pixel_Shader_Constant_Uncached(1,   color, 1);
		DX8Wrapper::Set_DX8_Pixel_Shader_Constant_Uncached(2,	D3DXVECTOR4(m_curFadeValue, m_curFadeValue, m_curFadeValue, 1.0f), 1);
/*		DX8Wrapper::Set_DX8_Pixel_Shader_Constant_Uncached(2,   D3DXVECTOR4(150.0f/255.0f, 150.0f/255.0f, 150.0f/255.0f, 0.0f), 1);
		DX8Wrapper::Set_DX8_Pixel_Shader_Constant_Uncached(3,   D3DXVECTOR4((765.0f/450.0f)/3, (765.0f/450.0f)/3, (765.0f/450.0f)/3, 1.0f), 1);
		DX8Wrapper::Set_DX8_Pixel_Shader_Constant_Uncached(4,   D3DXVECTOR4(0.5f, 0.5f, 0.5f, 0), 1);
		DX8Wrapper::Set_DX8_Pixel_Shader_Constant_Uncached(5,   D3DXVECTOR4((60.0f)/255.0f, (60.0f)/255.0f, (60.0f)/255.0f, 0), 1);
		DX8Wrapper::Set_DX8_Pixel_Shader_Constant_Uncached(6,   D3DXVECTOR4((157.0f)/255.0f, (157.0f)/255.0f, (157.0f)/255.0f, 0), 1);
		DX8Wrapper::Set_DX8_Pixel_Shader_Constant_Uncached(7,   D3DXVECTOR4((30.0f)/255.0f, (30.0f)/255.0f, (30.0f)/255.0f, 0), 1);
*/
		return true;
	}
	return false;
...
Int ScreenBWFilter::shutdown()
{
	if (m_dwBWPixelShader)
		DX8Wrapper::Delete_DX8_Pixel_Shader(m_dwBWPixelShader);
...
Bool ScreenCrossFadeFilter::postRender(FilterModes mode, Coord2D &scrollDelta,Bool &doExtraRender)
{
	...
	{	DX8Wrapper::Set_DX8_Texture_Uncached(1,m_fadePatternTexture->Peek_D3D_Texture());
...
*/
	...
	//draw polygons like this is very inefficient but for only 2 triangles, it's
	//not worth bothering with index/vertex buffers.
	DX8Wrapper::Set_DX8_Vertex_Shader_Uncached(D3DFVF_XYZRHW | D3DFVF_DIFFUSE | D3DFVF_TEX2);

//		m_DX8Wrapper::Set_DX8_Texture_Stage_State_Uncached(0,D3DTSS_MAGFILTER,D3DTEXF_POINT);
//		m_DX8Wrapper::Set_DX8_Texture_Stage_State_Uncached(0,D3DTSS_MINFILTER,D3DTEXF_POINT);
...
Bool ScreenMotionBlurFilter::postRender(FilterModes mode, Coord2D &scrollDelta,Bool &doExtraRender)
{
	...
	DX8Wrapper::Set_DX8_Texture_Stage_State_Uncached(0,D3DTSS_ALPHAARG1, D3DTA_CURRENT);
	DX8Wrapper::Set_DX8_Texture_Stage_State_Uncached(0,D3DTSS_ALPHAARG2, D3DTA_TEXTURE);
	DX8Wrapper::Set_DX8_Texture_Stage_State_Uncached(0,D3DTSS_ALPHAOP, D3DTOP_SELECTARG1);
	DX8Wrapper::Draw_DX8_Primitive_UP(D3DPT_TRIANGLESTRIP, 2, v, sizeof(_TRANS_LIT_TEX_VERTEX));
...
Int TerrainShader2Stage::set(Int pass)
{
	...
	{
		case 0:
			DX8Wrapper::Set_DX8_Texture_Uncached(0, W3DShaderManager::getShaderTexture(0)->Peek_D3D_Texture());
			DX8Wrapper::Set_DX8_Texture_Stage_State( 0, D3DTSS_ADDRESSU, D3DTADDRESS_CLAMP);
			DX8Wrapper::Set_DX8_Texture_Stage_State( 0, D3DTSS_ADDRESSV, D3DTADDRESS_CLAMP);
			...
			break;
		case 1:
			DX8Wrapper::Set_DX8_Texture_Uncached(0, W3DShaderManager::getShaderTexture(1)->Peek_D3D_Texture());
			DX8Wrapper::Set_DX8_Texture_Stage_State( 0, D3DTSS_ADDRESSU, D3DTADDRESS_CLAMP);
			DX8Wrapper::Set_DX8_Texture_Stage_State( 0, D3DTSS_ADDRESSV, D3DTADDRESS_CLAMP);
		...
		case 2:
			...
			{
				//setup cloud pass
				DX8Wrapper::Set_DX8_Texture_Uncached(0, W3DShaderManager::getShaderTexture(2)->Peek_D3D_Texture());
				...
				//setup noise pass
				DX8Wrapper::Set_DX8_Texture_Uncached(1, W3DShaderManager::getShaderTexture(3)->Peek_D3D_Texture());
			...
			{	//only 1 noise or cloud texture
				...
				{
					//setup noise pass
					DX8Wrapper::Set_DX8_Texture_Uncached(0, W3DShaderManager::getShaderTexture(3)->Peek_D3D_Texture());
...
Int TerrainShader8Stage::set(Int pass)
{
	if (pass == 0)
	{
		...
		DX8Wrapper::Set_DX8_Texture_Uncached(0, W3DShaderManager::getShaderTexture(0)->Peek_D3D_Texture());
		DX8Wrapper::Set_DX8_Texture_Uncached(1, W3DShaderManager::getShaderTexture(1)->Peek_D3D_Texture());
...
Int TerrainShaderPixelShader::shutdown()
{
	if (m_dwBasePixelShader)
		DX8Wrapper::Delete_DX8_Pixel_Shader(m_dwBasePixelShader);

	if (m_dwBaseNoise1PixelShader)
		DX8Wrapper::Delete_DX8_Pixel_Shader(m_dwBaseNoise1PixelShader);

	if (m_dwBaseNoise2PixelShader)
		DX8Wrapper::Delete_DX8_Pixel_Shader(m_dwBaseNoise2PixelShader);
...
Int TerrainShaderPixelShader::set(Int pass)
{
	...
	if (W3DShaderManager::getCurrentShader() >= W3DShaderManager::ST_TERRAIN_BASE_NOISE1)
	{
		...
		{	//full shader
			...
			DX8Wrapper::Set_DX8_Texture_Uncached(2, W3DShaderManager::getShaderTexture(2)->Peek_D3D_Texture());
			DX8Wrapper::Set_DX8_Texture_Uncached(3, W3DShaderManager::getShaderTexture(3)->Peek_D3D_Texture());
			DX8Wrapper::Set_DX8_Pixel_Shader_Uncached(m_dwBaseNoise2PixelShader);
		...
		{	//single noise texture shader
			DX8Wrapper::Set_DX8_Pixel_Shader_Uncached(m_dwBaseNoise1PixelShader);
			...
			{	//light map
				DX8Wrapper::Set_DX8_Texture_Uncached(2, W3DShaderManager::getShaderTexture(3)->Peek_D3D_Texture());
				terrainShader2Stage.updateNoise2(&curView,&inv);	//update curView with texture matrix
	...
	{	//just base texturing
		DX8Wrapper::Set_DX8_Pixel_Shader_Uncached(m_dwBasePixelShader);
	}
...
{
	DX8Wrapper::Set_DX8_Texture_Uncached(2,nullptr);	//release reference to any texture
	DX8Wrapper::Set_DX8_Texture_Uncached(3,nullptr);	//release reference to any texture
...
Int CloudTextureShader::set(Int stage)
{
	...
	DX8Wrapper::Set_DX8_Texture_Uncached(stage, W3DShaderManager::getShaderTexture(stage)->Peek_D3D_Texture());
...
void CloudTextureShader::reset()
{
	...
	DX8Wrapper::Set_DX8_Texture_Uncached(m_stageOfSet, nullptr);
...
void W3DShaderManager::init()
{
	...
	if ((res=W3DShaderManager::getChipset()) != 0)
	{
		...
		HRESULT hr=DX8Wrapper::Get_DX8_Render_Target_Surface(&m_oldRenderSurface);
		...
		{
			hr=DX8Wrapper::Create_DX8_Texture_Uncached(desc.Width,desc.Height,1,D3DUSAGE_RENDERTARGET,desc.Format,D3DPOOL_DEFAULT,&m_renderTexture);
		}
		else
		{
		...
		if (hr != S_OK)
		{
			...
			if (hr != S_OK)
			{
				...
				hr = DX8Wrapper::Get_DX8_Depth_Stencil_Surface(&m_oldDepthSurface);
				if (hr != S_OK)
				{
...
void W3DShaderManager::startRenderToTexture()
{
	...
	HRESULT hr = DX8Wrapper::Set_DX8_Render_Target_Surface(m_newRenderSurface,m_oldDepthSurface);
...
IDirect3DTexture8 *W3DShaderManager::endRenderToTexture()
{
	...
	HRESULT hr = DX8Wrapper::Set_DX8_Render_Target_Surface(m_oldRenderSurface,m_oldDepthSurface);	//restore original render target
...
ChipsetType W3DShaderManager::getChipset()
{
	...
	if (DX8Wrapper::_Get_D3D8() && DX8Wrapper::_Get_D3D_Device8())
	{
...
HRESULT W3DShaderManager::LoadAndCreateD3DShader(const char* strFilePath, const DWORD* pDeclaration, DWORD Usage, Bool ShaderType, DWORD* pHandle)
{
	...
	try
	{
		...
		{
			hr = DX8Wrapper::Create_DX8_Vertex_Shader(pDeclaration, pShader, pHandle, Usage);
		}
		else // SHADERTYPE_PIXEL
		{
			hr = DX8Wrapper::Create_DX8_Pixel_Shader(pShader, pHandle);
		}
...
Int FlatTerrainShaderPixelShader::shutdown()
{
	...
	if (m_dwBase0PixelShader)
		DX8Wrapper::Delete_DX8_Pixel_Shader(m_dwBase0PixelShader);
...
Int FlatTerrainShaderPixelShader::set(Int pass)
{
	...
	if (shroud) {
		...
		DX8Wrapper::Set_DX8_Texture_Stage_State( curStage, D3DTSS_MINFILTER, D3DTEXF_LINEAR);
		DX8Wrapper::Set_DX8_Texture_Stage_State( curStage, D3DTSS_MAGFILTER, D3DTEXF_LINEAR);
		DX8Wrapper::Set_DX8_Texture_Uncached(curStage, shroud->getShroudTexture()->Peek_D3D_Texture());
		curStage++;
	...
	if (doNoise1) {	 // Cloud pass.
		...
		DX8Wrapper::Set_DX8_Texture_Uncached(curStage, W3DShaderManager::getShaderTexture(2)->Peek_D3D_Texture());
		terrainShader2Stage.updateNoise1(&curView,&inv);	//update curView with texture matrix
		DX8Wrapper::_Set_DX8_Transform((D3DTRANSFORMSTATETYPE )(D3DTS_TEXTURE0+curStage), curView);
		DX8Wrapper::Set_DX8_Texture_Stage_State(curStage, D3DTSS_MINFILTER, D3DTEXF_LINEAR);
		DX8Wrapper::Set_DX8_Texture_Stage_State(curStage, D3DTSS_MAGFILTER, D3DTEXF_LINEAR);
	...
	if (doNoise2)
	{
		...
		DX8Wrapper::Set_DX8_Texture_Stage_State(curStage,  D3DTSS_ADDRESSU, D3DTADDRESS_WRAP);
		DX8Wrapper::Set_DX8_Texture_Stage_State(curStage,  D3DTSS_ADDRESSV, D3DTADDRESS_WRAP);
		DX8Wrapper::Set_DX8_Texture_Uncached(curStage, W3DShaderManager::getShaderTexture(3)->Peek_D3D_Texture());
		terrainShader2Stage.updateNoise2(&curView,&inv);	//update curView with texture matrix
		DX8Wrapper::_Set_DX8_Transform((D3DTRANSFORMSTATETYPE )(D3DTS_TEXTURE0+curStage), curView);
		DX8Wrapper::Set_DX8_Texture_Stage_State(curStage, D3DTSS_MINFILTER, D3DTEXF_LINEAR);
		DX8Wrapper::Set_DX8_Texture_Stage_State(curStage, D3DTSS_MAGFILTER, D3DTEXF_LINEAR);
	...
	if (curStage<2) {
		DX8Wrapper::Set_DX8_Pixel_Shader_Uncached(m_dwBase0PixelShader);
	}	else if (curStage==2) {
		DX8Wrapper::Set_DX8_Pixel_Shader_Uncached(m_dwBasePixelShader);
	}	else if (curStage==3) {
		DX8Wrapper::Set_DX8_Pixel_Shader_Uncached(m_dwBaseNoise1PixelShader);

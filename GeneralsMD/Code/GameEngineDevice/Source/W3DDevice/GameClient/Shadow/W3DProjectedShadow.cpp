...
/*						if (flipForBlend)
		...
		DX8Wrapper::Set_DX8_Transform_Uncached(D3DTS_WORLD,(_D3DMATRIX *)&mWorld);

		DX8Wrapper::Set_DX8_Stream_Source(0,shadowVertexBufferD3D,sizeof(SHADOW_VOLUME_VERTEX));
		DX8Wrapper::Set_DX8_Vertex_Shader_Uncached(SHADOW_VOLUME_FVF);

		Int numPolys = (endX - startX)*(endY - startY)*2;	//2 triangles per cell

		DX8Wrapper::Set_DX8_Render_State_Uncached(D3DRS_ALPHATESTENABLE, TRUE);	//should reject background pixels
		DX8Wrapper::Set_DX8_Render_State_Uncached( D3DRS_STENCILENABLE, TRUE );
		DX8Wrapper::Set_DX8_Render_State_Uncached( D3DRS_STENCILFUNC,     D3DCMP_ALWAYS );
		DX8Wrapper::Set_DX8_Render_State_Uncached( D3DRS_STENCILREF,      0x1 );
		DX8Wrapper::Set_DX8_Render_State_Uncached( D3DRS_STENCILMASK,     0xffffffff );
...
//    DX8Wrapper::Set_DX8_Render_State_Uncached( D3DRS_ALPHABLENDENABLE, FALSE );	//useful to see bounds
		...
		DX8Wrapper::Set_DX8_Render_State_Uncached(D3DRS_ALPHATESTENABLE, FALSE);	//should reject background pixels
...
//    DX8Wrapper::Set_DX8_Render_State_Uncached( D3DRS_ALPHABLENDENABLE, TRUE );
		DX8Wrapper::Set_DX8_Render_State_Uncached( D3DRS_LIGHTING, TRUE);
...
/*	UnsignedInt color=TheW3DShadowManager->getShadowColor();
	DX8Wrapper::Set_DX8_Render_State_Uncached( D3DRS_TEXTUREFACTOR, 0xff000000 | color);
	...
	DX8Wrapper::Set_DX8_Texture_Stage_State_Uncached(0, D3DTSS_COLORARG2, D3DTA_TFACTOR);

	DX8Wrapper::Set_DX8_Texture_Stage_State_Uncached(0, D3DTSS_ALPHAOP, D3DTOP_MODULATE);
	DX8Wrapper::Set_DX8_Texture_Stage_State_Uncached(0, D3DTSS_ALPHAARG1, D3DTA_TEXTURE);
	DX8Wrapper::Set_DX8_Texture_Stage_State_Uncached(0, D3DTSS_ALPHAARG2, D3DTA_TFACTOR);
*/
	...
	DX8Wrapper::Set_DX8_Vertex_Shader_Uncached(SHADOW_DECAL_FVF);
...
//	DX8Wrapper::Set_DX8_Render_State_Uncached(D3DRS_DESTBLEND,D3DBLEND_SRCCOLOR);	//restore W3D state
//	DX8Wrapper::Set_DX8_Render_State_Uncached(D3DRS_SRCBLEND, D3DBLEND_ZERO);

/*	DX8Wrapper::Set_DX8_Texture_Stage_State_Uncached(0, D3DTSS_COLOROP, D3DTOP_SELECTARG1);
	DX8Wrapper::Set_DX8_Texture_Stage_State_Uncached(0, D3DTSS_COLORARG1, D3DTA_TEXTURE);
	DX8Wrapper::Set_DX8_Texture_Stage_State_Uncached(0, D3DTSS_COLORARG2, D3DTA_CURRENT);
	DX8Wrapper::Set_DX8_Texture_Stage_State_Uncached(0, D3DTSS_ALPHAOP, D3DTOP_SELECTARG1);
	DX8Wrapper::Set_DX8_Texture_Stage_State_Uncached(0, D3DTSS_ALPHAARG1, D3DTA_TEXTURE);
	DX8Wrapper::Set_DX8_Texture_Stage_State_Uncached(0, D3DTSS_ALPHAARG2, D3DTA_CURRENT);
*/

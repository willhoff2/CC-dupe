...
> **674 / 762** clean native and **718 / 762** shimmed (clang 14, commit `632ba20`; the 673 / 761 and
> 717 / 761 measured at `3098ef1` moved by denominator, not by progress — PR #117 added one
> `GeneralsMD/Code/GameEngine` translation unit, clean in both modes). Read

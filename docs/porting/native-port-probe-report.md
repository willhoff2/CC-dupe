...
Compiled 147 translation units with `clang++ -fsyntax-only -std=c++20 -m64 -fms-extensions -ferror-limit=0 -include Utility/CppMacros.h -DWIN32_LEAN_AND_MEAN -D_REENTRANT` (no Windows SDK, no Wine).

- Translation units that already compile clean: **96 / 147** (65%)
- Translation units with errors: **51**
- Total errors: **125**
...
|---|---:|---:|---|
| Other | 51 | 21 | `Core/Libraries/Source/WWVegas/WWMath/vp.cpp: unknown type name 'sint64'` |
| Non-conforming template/name lookup | 35 | 5 | `Core/Libraries/Source/WWVegas/WWLib/cpudetect.cpp: use of undeclared identifier 'sint64'` |
...
| Core/Libraries/Source/WWVegas/WWDebug | 1 | 3 |
| Core/Libraries/Source/WWVegas/WWLib | 41 | 60 |
| Core/Libraries/Source/WWVegas/WWMath | 32 | 35 |
